...
SECRET_KEY = 'django-insecure-xa&jmyw(5jtadxw&2iaic$t_#e)o$hczm&&n#)36bo_9*elgci'

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = True

ALLOWED_HOSTS = ["pwelfarehome.onrender.com"]
...
STATICFILES_DIR = [
    ...
    os.path.join(BASE_DIR, 'portfolio/dist/static')
...
CORS_ORIGIN_WHITELIST = ['pwelfarehome.onrender.com',
