...
const reactLogoPath = `/src/assets/images/${reactLogo}`
const viteLogoPath = `/src/assets/images/${viteLogo}`
...
<div className="bg-image mt-0" >
        ...
        <div className="container text-center">
          <a href="http://localhost:5173/tracking" className="btn btn-danger mt-4" data-aos="fade-up-left">Learn More</a>
        </div>
      </div>
            ...
            <div className="d-flex">
                ...
                <div id="carouselExampleSlidesOnly" className="carousel slide" data-bs-ride="carousel">
                  <div className="carousel-inner" style={{ margin: '0 -100px' }} >
                    <div className="carousel-item active text-center"  >
                      <img src="http://localhost:5173/assets/images/fada9.jpg" className="d-block w-100" style={{ height: '288px' }} alt="..." />
              ...
              <div className="col-md-1">
                <div className="join" style={{ marginLeft: '-92px' }}>
                  <div className="jesus">
                    <img src="http://localhost:5173/assets/images/Jesus1sss.jpg" className="" alt="..." />

                  </div>

                  <div className="mary pt-2">

                    <img src="http://localhost:5173/assets/images/Marys.jpg" className="" alt="..." />
                  </div>
                </div>
              </div>
        ...
        <div className="container-fluid pt-3">
          <div className="row">
            ...
            <div className="col mt-6">
              <img src="http://localhost:5173/assets/images/fada9.jpg" className="rounded img-fluid mb-5" alt="about" />
      ...
      <div className="container pt-5 ">
        ...
        <div className="text-center " data-aos="fade-up">
          ...
          <a href="http://localhost:5173/Service" className="btn btn-danger">Load More</a>
        ...
        <div className="container">
          <div className="row pt-5 d-flex justify-content-center">
            ...
            <div className="col-md-4 text-md-end text-sm-start" data-aos="fade-up">
              <a href='http://localhost:5173/contact' className="btn btn-danger1">More Schedule</a>
            </div>
          </div>
            ...
            <div className="container">
              <div className="row">
                ...
                <div className="col-md-7">
                  ...
                  <img src="http://localhost:5173/assets/images/fada4.jpg" alt="" style={{ width: '390px', height: '470px' }} className='img-fluid rounded' data-aos="fade-up" />
                </div>
