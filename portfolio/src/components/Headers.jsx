...
function Headers() {
 ...
 // }
      ...
      return window.location = "http://localhost:5173/Service?Search=" + document.getElementById("Searchtextbox").value;
  }
}
  // const Search = () =>{
...
<nav className="fixed-top navbar navbar-expand-lg bg-body-tertiary" >
  <div className="container" >
    <a className=" navbar-brand " href="/" ><img src="http://localhost:5173/assets/images/logo.png" /></a>
    ...
    <li><a className="dropdown-item" href="http://localhost:5173/Service">Images Of Priests</a></li>
    <li><a className="dropdown-item" href="/">List Of Priests/Historical Life</a></li>
        ...
        <div className="dropdown">
          ...
          <ul className="dropdown-menu">
    <li><a className="dropdown-item" href="http://localhost:5173/Tracking">Our Conferences</a></li>
    ...
    <li><a className="dropdown-item" href="/">Birthday Celebration of the Priests</a></li>
        ...
        <div className="dropdown">
          ...
          <ul className="dropdown-menu">
    <li><a className="dropdown-item" href="http://localhost:5173/Service">All News</a></li>
    ...
    <li><a className="dropdown-item" href="/">Videos/Pictures</a></li>
      ...
      <a className="nav-link " href="http://localhost:5173/Contact"><i className="fa-solid fa-phone"></i>CONTACT</a>

    </li>

        <li className="nav-item">
      
          <a className="nav-link" href="http://localhost:5173/SupportUs">SUPPORT US</a>
