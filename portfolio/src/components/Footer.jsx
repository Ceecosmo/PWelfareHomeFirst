        ...
        <div className="row pt-2">
          ...
          <div className="col-md-3 mb-2">
            ...
            <div className="d-flex ">
              ...
              <img src="http://localhost:5173/assets/images/fada12.jpeg" alt="" className='img-fluid rounded' />
              </div>
              <div className="flex-grow-1 ms-2">
              <img src="http://localhost:5173/assets/images/fada10.jpeg" alt="" className='img-fluid rounded' />
            ...
            <div className="d-flex">
              <div className="flex-grow-1 mb-3 me-2">
              <img src="http://localhost:5173/assets/images/fada11.jpeg" alt="" className='img-fluid rounded' />
              </div>
              <div className="flex-grow-1 ms-2">
              <img src="http://localhost:5173/assets/images/fada12.jpeg" alt="" className='img-fluid rounded' />
